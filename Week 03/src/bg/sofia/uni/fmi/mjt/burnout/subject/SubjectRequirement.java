 ...
 * @throws IllegalArgumentException if the minimum amount of subjects enrolled are negative
 */
public record SubjectRequirement(Category category, int minAmountEnrolled) {
    public SubjectRequirement {
        ...
        if (minAmountEnrolled < 0) {
            throw new IllegalArgumentException("Minimum amount of subjects enrolled cannot be negative");
        }
    }
}
